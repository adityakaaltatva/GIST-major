...
import { FaGithub, FaGlobe, FaLock, FaRocket } from "react-icons/fa";
    ...
    <div className="w-screen min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-700 text-white font-sans">
      ...
      >
            ...
            {[
              {
                ...
                icon: <FaRocket size={36} className="text-purple-400" />,
              },
              {
                title: "GitHub Integration",
                desc: "Streamline CI/CD workflows with GitHub integration.",
                icon: <FaGithub size={36} className="text-blue-400" />,
              },
              {
                title: "Scalability",
                desc: "Designed for high-demand, cloud-native environments.",
                icon: <FaGlobe size={36} className="text-green-400" />,
              },
              {
                title: "Blockchain Security",
                desc: "Ensure transparency with tamper-proof deployments.",
                icon: <FaLock size={36} className="text-red-400" />,
              },
            ].map((feature, index) => (
              <motion.li
                key={index}
              ...
              >
                <div className="flex items-center space-x-4">
                  ...
                  <span className="block text-2xl font-bold text-white">{feature.title}</span>
                </div>
        ...
        <div className="text-center mt-8">
          <Link to="/deploy">
            <button className="px-8 py-3 bg-gradient-to-r from-purple-600 to-blue-500 hover:from-purple-700 hover:to-blue-600 rounded-lg text-lg font-semibold text-white shadow-md transform transition-transform hover:scale-110">
      ...
      {/* Navigation Section */}
      <motion.nav
        className="w-full bg-gray-800 py-6 mt-12 shadow-md"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ duration: 1 }}
      >
